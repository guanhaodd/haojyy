						...
						<form class="form form-horizontal" id = "form"  action="${ctx}/product/item/saveUpdate" onsubmit="return false;">
							<fieldset>
								<div class="span8 offset1">
									...
									<input type="hidden" name="typeId" id="typeId" value="${(type!=null&&type.id!='')?type.id:null}"/>
									<input type="hidden" name="isShow" id="isShow" value="1"/>
									<div class="control-group">
									  <label class="control-label">类型名称：</label>
									  <input type="text" readonly = "readonly" name="typeName" value="${(type!=null&&type.typeName!='')? type.typeName :'无' }"/>
									</div>
									<div class="control-group">
									  <label class="control-label" for="typeName">商品名称：</label>
									  <input type="text" class="form-control" id="itemName" placeholder="商品名称" name="itemName">
									</div>
									<div class="control-group">
									...
									<div class="control-group">
									  ...
									  <div class="span12">
									  	<textarea class="form-control" id="summary" name="summary" autofocus></textarea>
									  </div>
									</div>
									<div class="control-group">
										<div class="span12" style="text-align: center">商品详细介绍（用于详情页面）</div>
										<div class="span12">
										  	<textarea class="form-control" id="discribe" name="discribe" autofocus></textarea>
										</div>
									</div>
									<div class="control-group">
